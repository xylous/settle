...
pub fn build() -> Command
{
    ...
    .subcommand(Command::new("query")
        ...
        .arg(Arg::new("VIZK")
            .conflicts_with_all(["FORMAT", "LINK_SEP", "DOT_GRAPH", "JSON_GRAPH"])
            .display_order(10)
            .long("vizk")
            .num_args(0)
            .action(ArgAction::SetTrue)
            .help("generate a HTML which can interactively visualise the Zettelkasten")
        )
        .arg(Arg::new("DOT_GRAPH")
            .conflicts_with_all(["FORMAT", "LINK_SEP", "JSON_GRAPH"])
            .display_order(11)
            .long("dot_graph")
            .num_args(0)
            .action(ArgAction::SetTrue)
        ...
        .arg(Arg::new("JSON_GRAPH")
            .conflicts_with_all(["FORMAT", "LINK_SEP"])
            .display_order(12)
            .long("json_graph")
            .num_args(0)
            .action(ArgAction::SetTrue)
            .help("generate a graph in JSON format from the query results")
        )
